...
import { Trash2, Minus, Plus, ArrowLeft, Ruler, Edit, MessageCircle } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center justify-between mb-12 border-b border-neutral-100 dark:border-neutral-900 pb-8">
                    <div className="space-y-2">
                        <Link href="/shop" className="text-xs uppercase tracking-[0.2em] text-neutral-500 hover:text-black dark:hover:text-white flex items-center gap-2 group transition-colors">
                            <ArrowLeft className="w-3 h-3 transition-transform group-hover:-translate-x-1" /> Back to Shop
                        </Link>
                        <h1 className="font-serif text-4xl lg:text-5xl tracking-tight">Your Selection</h1>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
                                    ...
                                    <div className="sm:col-span-8 lg:col-span-9 flex flex-col">
                                        ...
                                        <div className="flex flex-wrap gap-x-8 gap-y-4 mb-6 py-4 border-y border-neutral-50 dark:border-neutral-900">
                                            <div className="space-y-1">
                                                <span className="text-[10px] uppercase tracking-[0.2em] text-neutral-500 block">Variant</span>
                                                <span className="text-xs font-bold uppercase">{item.selectedVariant}</span>
                                            </div>
                                            <div className="space-y-1">
                                                <span className="text-[10px] uppercase tracking-[0.2em] text-neutral-500 block">Size (Fit)</span>
                                                <span className="text-xs font-bold uppercase">{item.selectedSize}</span>
                                            </div>
                                            <div className="space-y-1">
                                                <span className="text-[10px] uppercase tracking-[0.2em] text-neutral-500 block">Length</span>
                                                <span className="text-xs font-bold uppercase">{item.selectedLength}</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                                            ...
                                            {item.note && (
                                                <div className="bg-neutral-50 dark:bg-neutral-900/50 p-4 rounded-sm space-y-3">
                                                    ...
                                                    <p className="text-xs italic text-neutral-600 dark:text-neutral-400">"{item.note}"</p>
                                                </div>
                                            )}
                                        </div>
                    ...
                    <div className="lg:col-span-4">
                        <div className="lg:sticky lg:top-32 bg-neutral-50 dark:bg-neutral-900 p-8 rounded-sm space-y-8">
                            <h2 className="font-serif text-2xl pb-4 border-b border-neutral-200 dark:border-neutral-800">Summary</h2>
