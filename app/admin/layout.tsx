      ...
      <div className="flex h-screen w-full bg-neutral-50 dark:bg-[#0a0a0a]">
        ...
        <SidebarInset className="flex flex-col h-full overflow-hidden">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 pl-4 border-l border-neutral-200 dark:border-neutral-800">
                <div className="text-right hidden sm:block">
                  <p className="text-xs font-semibold text-black dark:text-white leading-none">
                    Admin User
                  </p>
                  <p className="text-[10px] text-neutral-500 mt-0.5 uppercase tracking-wider font-bold">
                    Admin
                  </p>
                </div>
          ...
          <main className="flex-grow overflow-y-auto p-6 md:p-10">
            <div className="max-w-7-xl mx-auto">{children}</div>
          </main>
        </SidebarInset>
      </div>
    </SidebarProvider>
