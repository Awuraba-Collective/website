...
const orders = [
    { id: 'ORD-001', customer: 'Theodora Addei', date: '2026-01-06', total: 'GH₵ 1,250', status: 'Processing', items: 3 },
    { id: 'ORD-002', customer: 'Kofi Mensah', date: '2026-01-06', total: 'GH₵ 450', status: 'Shipped', items: 1 },
    { id: 'ORD-003', customer: 'Abena Serwaa', date: '2026-01-05', total: 'GH₵ 2,100', status: 'Delivered', items: 5 },
    { id: 'ORD-004', customer: 'Kwame Boateng', date: '2026-01-05', total: 'GH₵ 850', status: 'Pending', items: 2 },
    { id: 'ORD-005', customer: 'Ama Owusu', date: '2026-01-04', total: 'GH₵ 1,500', status: 'Processing', items: 4 },
    { id: 'ORD-006', customer: 'Ekow Arthur', date: '2026-01-04', total: 'GH₵ 300', status: 'Cancelled', items: 1 },
];
        ...
        <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-black border border-neutral-200 dark:border-neutral-800 rounded-2xl overflow-hidden shadow-sm">
                            ...
                            {orders.map((order, index) => (
                                ...
                                >
                                    <td className="px-6 py-4">
                                        <span className="text-sm font-bold text-black dark:text-white uppercase tracking-tight">{order.id}</span>
                                    </td>
                                    <td className="px-6 py-4">
                                        <div className="flex flex-col">
                                            <span className="text-sm font-semibold text-black dark:text-white">{order.customer}</span>
                                            <span className="text-xs text-neutral-500">{order.items} Items</span>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`inline-block px-2.5 py-1 rounded-full text-[10px] uppercase font-bold tracking-wider ${statusStyles[order.status]}`}>
                                            {order.status}
                                        </span>
                                    </td>
                ...
                <div className="px-6 py-4 flex items-center justify-between border-t border-neutral-100 dark:divide-neutral-900">
                    <p className="text-xs text-neutral-500 tracking-wide font-medium">Showing 1 to 6 of 154 orders</p>
                    <div className="flex items-center gap-2">
                        <button className="p-2 border border-neutral-200 dark:border-neutral-800 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-colors disabled:opacity-50" disabled>
