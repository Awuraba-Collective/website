...
export function Footer() {
    return (
        <footer className="w-full bg-neutral-50 px-6 py-12 dark:bg-neutral-900 border-t border-black/5 dark:border-white/10">
            <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-center justify-between gap-10 md:gap-6">
                <div className="flex flex-col items-center md:items-start gap-8 md:gap-2 order-2 md:order-1">
                    <div className="relative h-28 w-32 md:h-40 md:w-56 transition-all duration-300 -mt-16 md:-ml-8 flex justify-center">
                        <Image
                            src="/logos/black.svg"
                            alt="AWURABA Logo"
                            fill
                ...
                <div className="flex flex-col items-center md:items-end gap-6 order-1 md:order-2">
                    <div className="flex flex-col items-center md:items-end gap-3">
                        {/* <span className="text-[10px] uppercase tracking-widest font-bold text-neutral-400">Currency</span> */}
                        <CurrencySwitcher />
                    </div>
